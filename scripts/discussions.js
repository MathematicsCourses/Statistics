/*
    ...
    https://statistical-science.appspot.com/
    https://statistical-science.appspot.com/MyLabStatisticsGrades.html
*/
...
function gradeMLS(event) {
    ...
    var weightOneOne1st = parseFloat(document.getElementById("weightOneOne1st").value, 10) || 0,
        ...
        + weightOneTwo 
        + weightOneThree1st + weightOneThree2nd
        + weightTwoOne 
        + weightTwoTwo 
        + weightTwoThree 
        + weightTwoFour 
        + weightThreeOne1st + weightThreeOne2nd 
        + weightThreeTwo1st + weightThreeTwo2nd 
        + weightThreeThree1st + weightThreeThree2nd 
        + weightFourOne1st + weightFourOne2nd 
        + weightFourTwo1st + weightFourTwo2nd 
        + weightFourThree 
        + weightFiveOne
        + weightFiveTwo1st + weightFiveTwo2nd
        + weightSixOne1st + weightSixOne2nd
        + weightSixTwo 
        + weightSixThree 
        + weightSixFour 
        + weightSixFive 
        ...
        + weightedScoreOneTwo 
        + weightedScoreOneThree1st + weightedScoreOneThree2nd 
        + weightedScoreTwoOne
        + weightedScoreTwoTwo
        + weightedScoreTwoThree
        + weightedScoreTwoFour
        + weightedScoreThreeOne1st + weightedScoreThreeOne2nd 
        + weightedScoreThreeTwo1st + weightedScoreThreeTwo2nd
        + weightedScoreThreeThree1st + weightedScoreThreeThree2nd
        + weightedScoreFourOne1st + weightedScoreFourOne2nd 
        + weightedScoreFourTwo1st + weightedScoreFourTwo2nd
        + weightedScoreFourThree
        + weightedScoreFiveOne
        + weightedScoreFiveTwo1st + weightedScoreFiveTwo2nd
        + weightedScoreSixOne1st + weightedScoreSixOne2nd 
        + weightedScoreSixTwo
        + weightedScoreSixThree
        + weightedScoreSixFour
        + weightedScoreSixFive
