/*
   ...
   https://samuelchukwuemeka.github.io/correlation-regression/correlationRegressionCalculators-horizontal
*/
...
function spearman1(event) 
{
    ...
    document.getElementById("numeratorG").value = numeratorG;
    document.getElementById("denominatorG").value = denominatorG;
